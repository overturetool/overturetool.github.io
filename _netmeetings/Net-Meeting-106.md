...
We (KL and PJ) have added a [Frequently Asked Questions (FAQ) section](https://www.overturetool.org/faq/) to the overturetool.org website. Currently it addresses the issues that MacOS Sierra users may experience when they try to open a freshly downloaded version of Overture.
